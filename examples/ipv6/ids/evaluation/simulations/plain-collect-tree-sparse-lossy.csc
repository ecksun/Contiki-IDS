...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/../plain-rpl-collect/udp-sink.c</source>
      <commands EXPORT="discard">make udp-sink.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/../plain-rpl-collect/udp-sink.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/../plain-rpl-collect/udp-sender.c</source>
      <commands EXPORT="discard">make udp-sender.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/../plain-rpl-collect/udp-sender.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.9070165123533447 0.0 0.0 2.9070165123533447 -436.2315451918023 341.09273928005706</viewport>
    </plugin_config>
    <width>610</width>
    <z>0</z>
    <height>482</height>
